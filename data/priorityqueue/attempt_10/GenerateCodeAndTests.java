...
public class PriorityQueue<E> extends Object implements Queue<E> {
     ...
     * i elements of a class that implements java.lang.Comparable.
     */
    PriorityQueue() {}
    ...
    /**
     * Returns a shallow copy of this PriorityQueue instance.
     */
    ...
    /**
     * Protected method that retrieves the next last position in the heap. 
     */
    protected Position<E> nextLastPosition(E elem) {}

    /**
     * Protected method that moves a position down in the queue until its 
     * correct position is found.
     */
    protected void siftDown(Position<E> posicioAOrdenar) {}

    /**
     * Protected method that moves a position up in the queue until its 
     * correct position is found.
     */
